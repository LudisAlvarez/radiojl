...
export default function JinglePlayer() {
  ...
  // URL del jingle principal de la emisora
  const jingleUrl =
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/debate%20joven-0iK1w5OdLmkfo5rHMVHxEh5b1PZNVz.mp3" // Usando uno de los jingles proporcionados como ejemplo
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-lg">Escucha nuestro jingle</h3>
                        <p className="text-sm text-muted-foreground">¡La identidad sonora de nuestra emisora!</p>
                      </div>
                    </div>
